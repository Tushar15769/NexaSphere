...
export default function App() {
  // Skip intro for returning visitors; flag is set on first completion
  ...
  return (
    <>
      ...
      <main style={{paddingTop:nh,position:'relative',zIndex:1}}>
        ...
        {/* 404 fallback — unknown page type shows a friendly error instead of blank */}
...
function NotFoundPage({ onGoHome }) {
  return (
    <div style={{
      ...
      <p style={{color:'var(--t2)',fontSize:'1rem',maxWidth:'380px',lineHeight:1.7,marginBottom:'32px'}}>
