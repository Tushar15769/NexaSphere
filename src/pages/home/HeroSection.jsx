  ...
  return (
    <div style={{
      ...
      {items.map((s,i)=>(
        ...
        >
          <div className={`home-icon-pop ${vis ? 'pop-in fired' : ''}`} style={{fontSize:'.9rem',marginBottom:'2px', color: 'var(--c1)', transition: 'transform .3s cubic-bezier(.34,1.56,.64,1)', animationDelay: `${.5+i*.1}s` }}>{s.i}</div>
          <div style={{
